document.addEventListener('DOMContentLoaded', async function() {
    ...
    function generateIndicators(phaseNum) {
        return new Promise((resolve) => {
            ...
            const buttonWidth = phaseLength / phaseNum;
            const buttonMargin = buttonWidth / phaseNum / 3;
            const actualButtonWidth = buttonWidth + 2 * buttonMargin;

            ul.style.width = `${actualButtonWidth * phaseNum}px`;
            ...
            for (let i = 1; i <= phaseNum; i++) {
                ...
                button.style.margin = `0 ${buttonMargin}px`;
